...
<section class="bg-transparent py-3 py-md-5">
  <div class="container">
    <div class="row gy-3 gy-md-4 gy-lg-0 align-items-md-center">
      <div class="col-12 col-lg-6">
        <div class="row justify-content-xl-center">
          <div class="col-12 col-xl-11">
            ...
            <p class="lead fs-4 text-light mb-5">We're always on the lookout to work with new clients. If you're interested in working with us, please get in touch in one of the following ways.</p>
            <div class="d-flex mb-5">
              ...
              <div>
                ...
                <address class="mb-0 text-light">1867 Nairobi Kenya </address>
              </div>
            </div>
            <div class="row mb-5">
              <div class="col-12 col-sm-6">
                <div class="d-flex mb-5 mb-sm-0">
                  ...
                  <div>
                    ...
                    <p class="mb-0">
                      <a class="link-light text-decoration-none" href="tel:+15057922430">(+254) 724-648 627</a>
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="d-flex mb-0">
                  ...
                  <div>
                    ...
                    <p class="mb-0">
                      <a class="link-light text-decoration-none" href="mailto:brianeri14@gmail.com">brianeri14@gmail.com</a>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="d-flex">
              ...
              <div>
                ...
                <div class="d-flex mb-1">
                  ...
                  <p class="text-light mb-0">9am - 5pm</p>
                </div>
                <div class="d-flex">
                  <p class="text-light fw-bold mb-0 me-5">Sat - Sun</p>
                  <p class="text-light mb-0">9am - 2pm</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="col-12 col-lg-6">
        <div class="bg-danger border rounded shadow-sm overflow-hidden">
